...
var config = {
  apiOrigins: {
    production: 'https://faverestaurants.herokuapp.com'
  }
};
...
var indexRestaurant = function indexRestaurant() {
  return $.ajax({
    url: config.apiOrigin + '/restaurants',
    method: 'GET',
    headers: {
...
var updateRestaurant = function updateRestaurant(data) {
  return $.ajax({
...
var showRestaurant = function showRestaurant(id) {
  return $.ajax({
    url: config.apiOrigin + '/restaurants/' + id,
    method: 'GET',
    headers: {
...
var setAPIOrigin = __webpack_require__(13);
var config = __webpack_require__(4);
var authEvents = __webpack_require__(15);
var restaurantEvents = __webpack_require__(18);
...
$(function () {
  ...
  $('.show-fave-link').on('click', function () {
    $('.restaurant-divs').hide();
...
var parseNestedQuery = __webpack_require__(14);
...
var authApi = __webpack_require__(16);
var authUi = __webpack_require__(17);
...
var hideAuthDivs = function hideAuthDivs() {
  return $('.auth').hide();
};
var authMessage = function authMessage(text) {
  return $('.auth-message').text(text);
};
...
var getFormFields = __webpack_require__(5);
var restaurantApi = __webpack_require__(7);
var restaurantUi = __webpack_require__(19);

var onCreateNewRestaurant = function onCreateNewRestaurant(event) {
  var data = getFormFields(this);
  event.preventDefault();
  restaurantApi.createRestaurant(data).then(restaurantUi.createRestaurantSuccess).catch(restaurantUi.createRestaurantFailure);
};

var onIndexRestaurant = function onIndexRestaurant(event) {
  event.preventDefault();
  $('.restaurant-content').empty();
  $('.restaurant-divs').hide();
  $('.auth-message').hide();
  $('.restaurant-message').hide();
  restaurantApi.indexRestaurant().then(restaurantUi.indexRestaurantSuccess).catch(restaurantUi.indexRestaurantFailure);
};

var onShowRestaurant = function onShowRestaurant(event) {
  event.preventDefault();
  $('.restaurant-divs').hide();
  $('.auth-message').hide();
  $('.restaurant-message').hide();
  ...
  console.log(id);
  restaurantApi.showRestaurant(id).then(restaurantUi.showRestaurantSuccess).catch(restaurantUi.showRestaurantFailure);
};

module.exports = {
  onCreateNewRestaurant: onCreateNewRestaurant,
  onIndexRestaurant: onIndexRestaurant,
  onShowRestaurant: onShowRestaurant
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
var store = __webpack_require__(3);
var restaurantApi = __webpack_require__(7);
var showRestaurants = __webpack_require__(20);
var getOneRestaurant = __webpack_require__(37);
var getFormFields = __webpack_require__(5);

var hideRestaurantDivs = function hideRestaurantDivs() {
  return $('.restaurant-divs').hide();
};
var restaurantMessage = function restaurantMessage(text) {
  return $('.restaurant-message').text(text).show();
};

var createRestaurantSuccess = function createRestaurantSuccess(data) {
  restaurantMessage('Successfully created new favorite restaurant!');
  $('#create-fave').trigger('reset');
  hideRestaurantDivs();
};

var createRestaurantFailure = function createRestaurantFailure() {
  restaurantMessage('Error on creating new favorite restaurant! Please try again.');
  $('#create-fave').trigger('reset');
};

var deleteDiv = 'Are you sure you want to delete?<button type="submit" class="no-delete btn btn-default">No</button><button type="submit" class="yes-delete btn btn-default">Yes</button>';

var noDelete = function noDelete(event) {
  event.preventDefault();
  $(this).parent().hide();
  $('.confirmation').show();
};

var deleteRestaurantSuccess = function deleteRestaurantSuccess() {
  restaurantMessage('Successfully deleted!');
  var id = '[data-id="' + store.currentId + '"]';
  $(id).hide();
};

var deleteRestaurantFailure = function deleteRestaurantFailure() {
  restaurantMessage('Failed to delete');
};

var onYesDelete = function onYesDelete(event) {
  event.preventDefault();
  store.currentId = $(this).parent().parent().parent().attr('data-id');
  restaurantApi.deleteRestaurant(store.currentId).then(deleteRestaurantSuccess).catch(deleteRestaurantFailure);
};

var confirmDelete = function confirmDelete(event) {
  event.preventDefault();
...
var updateFormInputs = '<input class="r-name" name="restaurant[name]" type="text" value="">\n<input class="r-rating" name="restaurant[rating]" type="text" value="">\n<input class="r-neigh" name="restaurant[neighborhood]" type="text" value="">\n<button type="submit" class="update-button btn btn-default">Update This Restaurant</button>';

var updateRestaurantSuccess = function updateRestaurantSuccess() {
  restaurantMessage('Successfully updated restaurant!');
};

var updateRestaurantFailure = function updateRestaurantFailure() {
  restaurantMessage('Error updating restaurant! Please try again.');
};

var onUpdateRestaurant = function onUpdateRestaurant(event) {
  event.preventDefault();
  store.currentId = $(this).parent().parent().attr('data-id');
  var data = getFormFields(this);
  restaurantApi.updateRestaurant(data).then(updateRestaurantSuccess).catch(updateRestaurantFailure);
};

var getUpdateForm = function getUpdateForm(event) {
  event.preventDefault();
...
var indexRestaurantSuccess = function indexRestaurantSuccess(data) {
  hideRestaurantDivs();
  if (data.restaurants.length === 0) {
    restaurantMessage('No favorite restaurants, please add some!');
  } else {
    restaurantMessage('Here are all your favorite restaurants');
    var showRestaurantsHTML = showRestaurants({ restaurants: data.restaurants });
    $('.restaurant-content').append(showRestaurantsHTML).show();
    $(function () {
      return $('.confirmation').on('click', confirmDelete);
    });
    $(function () {
      return $('.update').on('click', getUpdateForm);
    });
  }
};

var indexRestaurantFailure = function indexRestaurantFailure(data) {
  hideRestaurantDivs();
  restaurantMessage('Error on getting all your favorite restaurants!');
};

var showRestaurantSuccess = function showRestaurantSuccess(data) {
  hideRestaurantDivs();
  restaurantMessage('Here is your favorite restaurant:');
  var getOneRestaurantHTML = getOneRestaurant({ restaurant: data.restaurant });
  $('.one-restaurant').remove();
  $('.restaurant-content').append(getOneRestaurantHTML).show();
  $('#show-fave').trigger('reset');
};

var showRestaurantFailure = function showRestaurantFailure() {
  hideRestaurantDivs();
...
module.exports = {
  ...
  indexRestaurantSuccess: indexRestaurantSuccess,
  indexRestaurantFailure: indexRestaurantFailure,
  showRestaurantSuccess: showRestaurantSuccess,
  showRestaurantFailure: showRestaurantFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<div class=\"one-restaurant\">\n  <ul data-id=\""
    ...
    + "</span></li>\n  <li class=\"rating\">\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.rating : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "  </li>\n  <li class=\"neighborhood\">\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.neighborhood : stack1),{"name":"if","hash":{},"fn":container.program(6, data, 0, blockParams),"inverse":container.program(8, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "  </li>\n  <li class=\"show-id\">ID: <span>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "</span></li>\n  <li><form class=\"update-form\"></form><button class=\"update btn btn-default\">Update</button></li>\n  <li><p class=\"confirm-delete\"><button class=\"confirmation btn btn-default\">Delete</button></p></li>\n  </ul>\n</div>\n";
},"2":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "      Rating: <span>"
    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.rating : stack1), depth0))
    + "</span>\n";
},"4":function(container,depth0,helpers,partials,data) {
    return "      Rating: <span>N/A</span>\n";
},"6":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "      Neighborhood: <span>"
    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.neighborhood : stack1), depth0))
    + "</span>\n";
},"8":function(container,depth0,helpers,partials,data) {
    return "      Neighborhood: <span>N/A</span>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.restaurants : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "      Rating: <span>"
    + container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? depth0.restaurant : depth0)) != null ? stack1.rating : stack1), depth0))
    + "</span>\n";
  ...
  return "      Neighborhood: <span>"
    + container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? depth0.restaurant : depth0)) != null ? stack1.neighborhood : stack1), depth0))
    + "</span>\n";
  ...
  return "<ul data-id=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.restaurant : depth0)) != null ? stack1.id : stack1), depth0))
    + "\">\n  <li class=\"name\">Name: <span>"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.restaurant : depth0)) != null ? stack1.name : stack1), depth0))
    + "</span></li>\n  <li class=\"rating\">\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = (depth0 != null ? depth0.restaurant : depth0)) != null ? stack1.rating : stack1),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(3, data, 0),"data":data})) != null ? stack1 : "")
    + "  </li>\n  <li class=\"neighborhood\">\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = (depth0 != null ? depth0.restaurant : depth0)) != null ? stack1.neighborhood : stack1),{"name":"if","hash":{},"fn":container.program(5, data, 0),"inverse":container.program(7, data, 0),"data":data})) != null ? stack1 : "")
    + "  </li>\n  <!-- <li><form class=\"update-form\"></form><button class=\"update btn btn-default\">Update</button></li>\n  <li><p class=\"confirm-delete\"><button class=\"confirmation btn btn-default\">Delete</button></p></li> -->\n  </ul>\n";
},"useData":true});
